...
public class DialogView : MonoBehaviour
{
    ...
    public void UpdateDialogueUI(string dialogue, string characterName)
    {
        ...
        {
            Debug.LogError("UI елементи не присвоєні!");
        }
    }
    ...
    public void DisplayCharacterImage(string characterName, int pose)
    {
        ...
        {
            Debug.LogError($"Персонаж {characterName} не знайдено");
        }
    }
    ...
    public void SetCharacterPosition(string position)
    {
        ...
        if (position == "left")
        {
            ...
            nameBox.rectTransform.anchoredPosition = new Vector2(-190, nameBox.rectTransform.anchoredPosition.y);
        }
        else if (position == "right")
        {
            objLeft.SetActive(false);
            objRight.SetActive(true);
            nameBox.rectTransform.anchoredPosition = new Vector2(970, nameBox.rectTransform.anchoredPosition.y);
        }
    }
}
